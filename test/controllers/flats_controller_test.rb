...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flat" do
    assert_difference('Flat.count') do
      post flats_url, params: { flat: { address: @flat.address, name: @flat.name, published: @flat.published } }
    end
  ...
  test "should update flat" do
    patch flat_url(@flat), params: { flat: { address: @flat.address, name: @flat.name, published: @flat.published } }
